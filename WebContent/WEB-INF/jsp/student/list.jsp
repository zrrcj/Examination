...
//# sourceURL=http://student/lista.js
//数据初始化
var pagesizse=${record}
$(function() {
	$("#aa").AjaxTables("/KsSystem/student/json.action?r="+new Date().getTime());
	...
	function showWindow(t) {
		...
		$("#responsive").modal({
			//remote:'<%=application.getContextPath()%>/student/json'
		});
	}
	//ajax分页数据展示
	function AjaxPage(pageSize, buttons, total) {
        $(".niuniu-pagination").jBootstrapPage({
            ...
            onPageClicked: function(obj, pageIndex) {
            	$("#aa").AjaxTables("/KsSystem/student/json.action","?pageindex="+(pageIndex+1)+"&pagesize="+pageSize+"&r="+new Date().getTime())
            }
            });
    }
	//保存方法
		...
		<div class="portlet">
			<div class="portlet-title">
				<div class="actions" style="padding-bottom: 10px;">
					<a id="add" onclick="showWindow(this)" hrefs="/KsSystem/student/list_model.action" data-toggle="modal" href="#"

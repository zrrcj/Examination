...
$(function() {
	$("#h").load("/KsSystem/subject/list_table.action?r="+new Date().getTime())
	...
	function AjaxPage(pageSize, buttons, total) {
        $(".niuniu-pagination").jBootstrapPage({
            ...
            onPageClicked: function(obj, pageIndex) {
            	$("#h").load("/KsSystem/subject/list_table.action?pageindex="+(pageIndex+1)+"&pagesize="+pageSize+"&r="+new Date().getTime())
            }
            });
    }
	//保存方法
...
<div class="row">
	<div class="col-md-12" style="margin-bottom: 15px;">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><i class="fa fa-home"></i> <a href="index.action"> 主页 </a> <i
		...
		<div class="portlet">
			<div class="portlet-title">
				<div class="actions" style="padding-bottom: 10px;">
					<a id="add" onclick="showWindow(this)" hrefs="/KsSystem/subject/list_model.action" data-toggle="modal" href="#"
